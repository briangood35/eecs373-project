...
#define DSPL_MOSI_Pin GPIO_PIN_7
#define DSPL_MOSI_GPIO_Port GPIOA
#define DISPL_RST_Pin GPIO_PIN_12
#define DISPL_RST_GPIO_Port GPIOF
#define DISPL_CS_Pin GPIO_PIN_13
...
#define DISPL_SCKB10_Pin GPIO_PIN_10
#define DISPL_SCKB10_GPIO_Port GPIOB
#define DISPL_LED_Pin GPIO_PIN_5
