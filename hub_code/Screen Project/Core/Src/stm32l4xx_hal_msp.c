...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_4|DISPL_SCK_Pin|DISPL_MISO_Pin|DSPL_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(DISPL_SCKB10_GPIO_Port, DISPL_SCKB10_Pin);
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_0|DISPL_LED_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_3|GPIO_PIN_5|GPIO_PIN_6);
